...
class General(commands.Cog):
    ...
    async def sources(self, ctx, *, arg):
        ...
        if chars == 'which jack':
            ...
            note = 'Bonus characters will not participate in the tournament, but will be able to receive arrangements. \n\n This character has no official description associated with them. This description is neither written nor endorsed by the SiIvaGunner team, and was written by the developer of the bot, sks316.'
        ...
        embed.set_footer(text="Requested by " + ctx.author.name + "#" + ctx.author.discriminator + " - " + botver + " by sks316#2523", icon_url=ctx.author.avatar_url)
    ...
    async def links(self, ctx):
        ...
        emb1.set_footer(text="Requested by " + ctx.author.name + "#" + ctx.author.discriminator + " - " + botver + " by sks316#2523", icon_url=ctx.author.avatar_url)
        ...
        emb2.set_footer(text="Requested by " + ctx.author.name + "#" + ctx.author.discriminator + " - " + botver + " by sks316#2523", icon_url=ctx.author.avatar_url)
